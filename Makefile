...
# 可在make是带入参数进行替换
# eg: make SERVICE_NAME=parrot-service build
SERVICE_NAME?=parrot-service

# build with version infos
versionDir = "github.com/go-parrot/parrot/pkg/version"
...
PROJECT_NAME := "github.com/go-parrot/parrot-starter"
PKG := "$(PROJECT_NAME)"
...
docker:
	docker build -t parrot:$(versionDir) -f deploy/docker/Dockeffile .
...
graph:
	...
	@go-callvis github.com/go-parrot/parrot
